...
\begin{exercise}
  Show that H n has exactly 2 n · n! automorphisms. Be careful: it is easy to construct 2 n · n! diﬀerent automorphisms. It is more diﬃcult to show that there are no automorphisms other than those.
\end{exercise}
...
\begin{exercise}
  Exercise 6.6. Characterize the natural numbers n for which there is a selfcomplementary graph G on n vertices.
\end{exercise}
