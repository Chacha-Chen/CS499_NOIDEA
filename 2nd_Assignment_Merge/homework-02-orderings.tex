...
\begin{exercise}
  ...
  \textbf{solution:} Yes.For every  $k \in \N$, there is an antichain like$ (1,0,...,0), (0,1,...0),...,(0,0,...,1)$, which is an antichain.
\end{enumerate}
\end{exercise}
...
\textbf{solution:} The longest chain of  $\{0,1\}^n$ is $ 00...0, 00...1,00...11,..., 11...1$.
