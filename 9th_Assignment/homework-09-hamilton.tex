...
\end{proof}
\begin{enumerate}
	\item For a tree, choose a longest line as main line.Clearly we have the following conclusion: trees of different length of main line must not be isomorphisms.
	\item Then to get different trees, by adding shorter lines to the main line, making sure .
		\begin{enumerate}
			\item 
			\item The shorest main line 
		\end{enumerate}
\end{enumerate}
\begin{exerciseDD}
